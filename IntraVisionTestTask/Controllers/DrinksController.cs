...
namespace IntraVisionTestTask.Controllers
{
    ...
    public class DrinksController : ControllerBase, IDisposable
    {
        ...
        {
            await _drinksRepository.Add(null);
        }
        ...
        {
            await _drinksRepository.Update(idDrink, drink);
        }
